...
import {assert, HTMLspecialChars, getRefID, isHeapRef, varnameToCssID} from './../utilities/functions';

require('../../javascript/D3/d3.v3.min.js');
    ...
    constructor(owner, domRoot, domRootD3) {
        ...
        var codeVizHTML =
            '<div class="tab">\
                ...
                <button class="tablinks" id="graphTab">Graph</button>\
            </div>\
        ...
        this.domRoot.find("#graphTab").click(() => { this.openTab(event, 'graph'); });
