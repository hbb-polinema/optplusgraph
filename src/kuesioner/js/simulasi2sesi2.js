    ...
    switch (currentQuestion) {
        case 1:
            ...
            if (document.getElementById('answerP1').value != '') {
                if (viz1 != null) {
                    if (checkFromDB(35) == 'belum') saveToDB(document.getElementById('answerP1').value, 35);
                    goTop();
                } else {
                    valid = false;
        ...
        case 2:
            ...
            if (document.getElementById('answerP2').value != '') {
                if (viz2 != null) {
                    if (checkFromDB(36) == 'belum') saveToDB(document.getElementById('answerP2').value, 36);
                    goTop();
                } else {
                    valid = false;
        ...
        case 3:
            ...
            if (document.getElementById('answerP3').value != '') {
                if (viz3 != null) {
                    if (checkFromDB(30) == 'belum') saveToDB(document.getElementById('answerP3').value, 30);
                    goTop();
                } else {
                    valid = false;
